...
namespace csharp.sapl.pdp.api
{
	...
	public interface IPolicyDecisionPoint
	{
		...
		IObserver<AuthorizationDecision> DecideOnce(AuthorizationSubscription authzSubscription);

		public IEnumerator<IdentifiableAuthorizationDecision> DecideOnce(
		...
		/// </summary>
		IObserver<AuthorizationDecision> Decide(AuthorizationSubscription authzSubscription);
		...
		/// </summary>
		IEnumerator<IdentifiableAuthorizationDecision> Decide(MultiAuthorizationSubscription multiAuthzSubscription);
		...
		/// </summary>
		IObserver<MultiAuthorizationDecision> DecideAll(MultiAuthorizationSubscription multiAuthzSubscription);

		Task<AuthorizationDecision> DecideOnceAsync(AuthorizationSubscription authzSubscription);
