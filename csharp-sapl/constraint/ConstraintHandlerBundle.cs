...
namespace csharp.sapl.constraint
{
	...
	public class ConstraintHandlerBundle
	{
		...
		private readonly Action onDecisionHandlers = NOP;
		private readonly Action onCancelHandlers = NOP;
		private readonly Action onCompleteHandlers = NOP;
		private readonly Action onTerminateHandlers = NOP;
		private readonly Action afterTerminateHandlers = NOP;
		//private readonly Action<T> consumerHandlers = _ => { };
		...
		public ConstraintHandlerBundle()
		{

		}

		public ConstraintHandlerBundle(Action onDecisionHandlers, Action onCancelHandlers, Action onCompleteHandlers,
					Action onTerminateHandlers, Action afterTerminateHandlers)
			//Action<T> consumerHandlers)
		{
