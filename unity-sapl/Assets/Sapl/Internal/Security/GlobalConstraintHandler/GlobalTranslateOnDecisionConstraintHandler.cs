...
{
    /// <summary>Translate game object constraint Handler for "OnDecision" constraints</summary>
	public class GlobalTranslateOnDecisionConstraintHandler : OnDecisionConstraintHandler, IJsonConsumerConstraintHandlerProvider
    {
        private const string constraintToken = "Translate:OnDecision";
