...
///<summary>
/// Custom editor for <see cref="GameObjectEnforcement"/>
/// and derived classes
///</summary>
namespace Sapl.Internal.Inspectors
{
    [CustomEditor(typeof(EnforcementBase), true)]
    class EnforcementBaseInspector : Editor
    {
        public override void OnInspectorGUI()
        {
            base.OnInspectorGUI();
            PropertySetter.SetProperty(target);
