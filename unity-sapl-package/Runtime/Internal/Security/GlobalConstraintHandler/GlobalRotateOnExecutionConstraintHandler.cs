...
{
    /// <summary>Rotate game object constraint Handler for "OnExecution" constraints</summary>
	public class GlobalRotateOnExecutionConstraintHandler : OnExecutionConstraintHandler, IJsonConsumerConstraintHandlerProvider
    {
        private const string constraintToken = "Rotate:OnExecution";
