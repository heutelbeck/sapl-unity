...
{
	/// <summary>Logging constraint Handler for "OnDecision" constraints</summary>
	public class GlobalLoggingOnDecisionConstraintHandler : OnDecisionConstraintHandler, IJsonConsumerConstraintHandlerProvider
    {
        private static readonly string constraintToken = "Logging:OnDecision";
