...
namespace Sapl.Internal.Security.Constraints
{
	...
	/// are useful to execute OnDecision.
	///
	///</summary>
	public class OnDecisionConstraintHandlerBundle
	{
        ...
        /// <summary>Initializes a new instance of the <see cref="OnDecisionConstraintHandlerBundle" /> class.</summary>
        public OnDecisionConstraintHandlerBundle()
		{
        ...
        public OnDecisionConstraintHandlerBundle(Action runnableHandlers, Action<GameObject> gameObjectConsumerHandlers,
		...
		///<summary>
		/// Runs all GameObject consumer handlers.
		///</summary>
